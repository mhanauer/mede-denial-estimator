...
# Display adjusted and actual data side by side for comparison
st.subheader(f'Comparison: Actual vs Adjusted Allowed Amount for {selected_cpt}')
comparison_df = filtered_df[['month', 'count', 'denial_rate', 'allowed_amount', 'adjusted_allowed_amount']]
